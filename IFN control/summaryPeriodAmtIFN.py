...
a "IFNdataSummary" containing a CSV file summarizing the information
obtained from PeriodAmtIFN.py after running the following cases 
...
def read_data(path,filename):
    ...
    df.columns = ['TreatmentPeriod0','TreatmentPeriod1','IFNAmountTreatment',\
...
def read_profile(path,filename):
    ...
    dfprof.columns = ['time','Csol','Ssol','Isol','Tsol','control'] 
    os.chdir(workingdir)
...
def read_injection(path,filename):
    ...
    dfinj.columns = ['IFNinj_t1','IFNinj_t2'] 
    os.chdir(workingdir)
...
path = os.getcwd()+'/'+'IFNdatafile'

filename = ['IFNsummary_[C0,I0]=[3,2].csv',\
            'IFNsummary_[C0,I0]=[1,2].csv',\
            'IFNsummary_[C0,I0]=[1,0.5].csv',\
            'IFNsummary_[C0,I0]=[4,0.3].csv']
...
for j in range(len(filename)):
    ...
    CritPeriod0 = np.append(CritPeriod0,df['CritPeriod0'])
    CritPeriod1 = np.append(CritPeriod1,df['CritPeriod1'])
    IFNAmountCrit = np.append(IFNAmountCrit,df['IFNAmountCrit'])
    MainPeriod0 = np.append(MainPeriod0,df['MainPeriod0'])
    MainPeriod1 = np.append(MainPeriod1,df['MainPeriod1'])
    IFNAmountMain = np.append(IFNAmountMain,df['IFNAmountMain'])
...
dfnew['CritPeriod0'] = CritPeriod0
dfnew['CritPeriod1'] = CritPeriod1
dfnew['IFNAmountCrit'] = IFNAmountCrit
dfnew['MainPeriod0'] = MainPeriod0
dfnew['MainPeriod1'] = MainPeriod1
dfnew['IFNAmountMain'] = IFNAmountMain
...
dfnew.to_csv('IFNsummary.csv',index=False)
...
mycolors = ['mediumseagreen']*4#['C3','C1','C0','C2']
#mylabels = [r'$(C_0,I_0)=(4,0.3)$',r'$(C_0,I_0)=(3,2)$',r'$(C_0,I_0)=(1,2)$',\
#            r'$(C_0,I_0)=(1,0.5)$']
...
plt.title(r'Total amount of IFN-$\beta$ used for entire duration',\
          fontsize=22)
...
plt.savefig('IFNonly_totIFNAmount.tif',\
...
pathprof = os.getcwd()+'/'+'IFNdatafile'

fileprof = ['IFNdata_[C0,I0]=[3,2].csv',\
            'IFNdata_[C0,I0]=[1,2].csv',\
            'IFNdata_[C0,I0]=[1,0.5].csv',\
            'IFNdata_[C0,I0]=[4,0.3].csv']
...
fileprof = ['IFNinjsummary_[C0,I0]=[3,2].csv',\
            'IFNinjsummary_[C0,I0]=[1,2].csv',\
            'IFNinjsummary_[C0,I0]=[1,0.5].csv',\
            'IFNinjsummary_[C0,I0]=[4,0.3].csv']

dfinj1 = read_injection(pathprof,fileprof[0])
IFNinj_t11 = dfinj1['IFNinj_t1']
IFNinj_t21 = dfinj1['IFNinj_t2']

dfinj2 = read_injection(pathprof,fileprof[1])
IFNinj_t12 = dfinj2['IFNinj_t1']
IFNinj_t22 = dfinj2['IFNinj_t2']

dfinj3 = read_injection(pathprof,fileprof[2])
IFNinj_t13 = dfinj3['IFNinj_t1']
IFNinj_t23 = dfinj3['IFNinj_t2']

dfinj4 = read_injection(pathprof,fileprof[3])
IFNinj_t14 = dfinj4['IFNinj_t1']
IFNinj_t24 = dfinj4['IFNinj_t2']
...
plt.text(0.3,2.5,'anti-tumorigenic\n       region',fontsize=24)
plt.text(2.75,0.75,'tumorigenic\n    region',fontsize=24)
plt.text(C0[0]+0.1,I0[0]-0.05,r'$Q_1$',fontsize=20, bbox=bbox1)
plt.text(C0[1]-0.25,I0[1]+0.15,r'$Q_2$',fontsize=20, bbox=bbox2)
...
ax1.fill_between(time1,uLcontrol1,0,\
        where=uLcontrol1>=0,color='mediumseagreen',alpha=0.5,interpolate=True)
ax1.set_ylim([0,2.5])
ax1.yaxis.set_tick_params(labelsize=20)
ax1.set_ylabel(r'IFN-$\beta$',color='C2',fontsize=20)
ax1.tick_params(axis='y', labelcolor='C2')
ax1.text(-4,2.2,r'$Q_1$',fontsize=24, bbox=bbox1)
...
ax1b.axvline(dfnew['CritPeriod1'][0],color='k',linestyle='--',linewidth=2)
ax1b.annotate('', xy=(0, 3), xycoords='data',
             xytext=(dfnew['TreatmentPeriod1'][0], 3), textcoords='data',
             arrowprops=dict(arrowstyle='<->', connectionstyle='arc3', 
                            color='red'))
ax1b.text(0,3.2,r'$\mathrm{\mathbb{P}}_{\rm t}$',color='red',fontsize=20)
ax1b.annotate('', xy=(dfnew['CritPeriod0'][0], 3), xycoords='data',
             xytext=(dfnew['CritPeriod1'][0], 3), textcoords='data',
             arrowprops=dict(arrowstyle='<->', connectionstyle='arc3', 
                            color='green'))
ax1b.text((dfnew['CritPeriod0'][0]+dfnew['CritPeriod1'][0])/2.6,\
         3.2,r'$\mathrm{\mathbb{P}}_{\rm crit}$',color='green',fontsize=20)
ax1b.annotate('', xy=(dfnew['MainPeriod0'][0], 3), xycoords='data',
             xytext=(Tsim, 3), textcoords='data',
             arrowprops=dict(arrowstyle='<->', connectionstyle='arc3', 
                            color='blue'))
ax1b.text((dfnew['MainPeriod0'][0]+Tsim)/2.1,\
         3.2,r'$\mathrm{\mathbb{P}}_{\rm m}$',color='blue',fontsize=20)
...
ax1b.legend(bbox_to_anchor=(0, 1, 1, .225), loc=1, ncol=5,borderaxespad=0,\
           prop={'size': 16})
...
ax2.fill_between(time2,uLcontrol2,0,\
        where=uLcontrol2>=0,color='mediumseagreen',alpha=0.5,interpolate=True)
ax2.set_ylim([0,2.5])
ax2.yaxis.set_tick_params(labelsize=20)
ax2.set_ylabel(r'IFN-$\beta$',color='C2',fontsize=20)
ax2.tick_params(axis='y', labelcolor='C2')
ax2.text(-4,2.2,r'$Q_2$',fontsize=24, bbox=bbox2)
...
ax2b.axvline(dfnew['TreatmentPeriod0'][1]+1,color='k',linestyle='--',linewidth=2)
ax2b.axvline(dfnew['CritPeriod1'][1],color='k',linestyle='--',linewidth=2)
ax2b.annotate('', xy=(0, 3), xycoords='data',
             xytext=(dfnew['TreatmentPeriod0'][1]+1, 3), textcoords='data',
             arrowprops=dict(arrowstyle='<->', connectionstyle='arc3', 
                            color='red'))
ax2b.text((dfnew['TreatmentPeriod0'][1]+1)/2.4,\
         3.2,r'$\mathrm{\mathbb{P}}_{\rm t}$',color='red',fontsize=20)
ax2b.annotate('', xy=(dfnew['TreatmentPeriod0'][1]+1, 3), xycoords='data',
             xytext=(dfnew['CritPeriod1'][1], 3), textcoords='data',
             arrowprops=dict(arrowstyle='<->', connectionstyle='arc3', 
                            color='green'))
ax2b.text((dfnew['TreatmentPeriod0'][1]+1+dfnew['CritPeriod1'][1])/2.1,\
         3.2,r'$\mathrm{\mathbb{P}}_{\rm crit}$',color='green',fontsize=20)
ax2b.annotate('', xy=(dfnew['MainPeriod0'][1], 3), xycoords='data',
             xytext=(Tsim, 3), textcoords='data',
             arrowprops=dict(arrowstyle='<->', connectionstyle='arc3', 
                            color='blue'))
ax2b.text((dfnew['MainPeriod0'][1]+Tsim)/2.1,\
         3.2,r'$\mathrm{\mathbb{P}}_{\rm m}$',color='blue',fontsize=20)
...
plt.savefig('Figure 5A-1.tif', dpi=300, pad_inches=0)
...
ax3.fill_between(time3,uLcontrol3,0,\
        where=uLcontrol3>=0,color='mediumseagreen',alpha=0.5,interpolate=True)
ax3.set_ylim([0,5])
ax3.yaxis.set_tick_params(labelsize=20)
ax3.set_ylabel(r'IFN-$\beta$',color='C2',fontsize=20)
ax3.tick_params(axis='y', labelcolor='C2')
ax3.text(-4,4.9,r'$Q_3$',fontsize=24, bbox=bbox3)
ax3.xaxis.set_tick_params(labelsize=20)

ax3b = ax3.twinx()
ax3b.plot(time3,Csol3,color='C0',linewidth=3,label=r'$C$')
ax3b.plot(time3,Isol3,color='m',linewidth=3,label=r'$C$')
ax3b.plot(time3,Ssol3,color='C2',linewidth=3,label=r'$C$')
...
ax3b.axvline(dfnew['CritPeriod1'][2],color='k',linestyle='--',linewidth=2)
ax3b.annotate('', xy=(dfnew['TreatmentPeriod0'][2], 3), xycoords='data',
             xytext=(dfnew['TreatmentPeriod1'][2], 3), textcoords='data',
             arrowprops=dict(arrowstyle='<->', connectionstyle='arc3', 
                            color='red'))
ax3b.text((dfnew['TreatmentPeriod0'][2]+dfnew['TreatmentPeriod1'][2])/2.75,\
         3.2,r'$\mathrm{\mathbb{P}}_{\rm t}$',color='red',fontsize=20)
ax3b.annotate('', xy=(dfnew['CritPeriod0'][2], 3), xycoords='data',
             xytext=(dfnew['CritPeriod1'][2], 3), textcoords='data',
             arrowprops=dict(arrowstyle='<->', connectionstyle='arc3', 
                            color='green'))
ax3b.text((dfnew['CritPeriod0'][2]+dfnew['CritPeriod1'][2])/2.65,\
         3.2,r'$\mathrm{\mathbb{P}}_{\rm crit}$',color='green',fontsize=20)
ax3b.annotate('', xy=(dfnew['MainPeriod0'][2], 3), xycoords='data',
             xytext=(Tsim, 3), textcoords='data',
             arrowprops=dict(arrowstyle='<->', connectionstyle='arc3', 
                            color='blue'))
ax3b.text((dfnew['MainPeriod0'][2]+Tsim)/2.1,\
         3.2,r'$\mathrm{\mathbb{P}}_{\rm m}$',color='blue',fontsize=20)
...
ax4.fill_between(time4,uLcontrol4,0,\
        where=uLcontrol4>=0,color='mediumseagreen',alpha=0.5,interpolate=True)
ax4.set_ylim([0,7.6])
ax4.yaxis.set_tick_params(labelsize=20)
ax4.set_ylabel(r'IFN-$\beta$',color='C2',fontsize=20)
ax4.tick_params(axis='y', labelcolor='C2')
ax4.text(-4,7.5,r'$Q_4$',fontsize=24, bbox=bbox4)
...
ax4b.axvline(dfnew['CritPeriod1'][3],color='k',linestyle='--',linewidth=2)
...
ax4b.annotate('', xy=(dfnew['CritPeriod0'][3], 4), xycoords='data',
             xytext=(dfnew['CritPeriod1'][3], 4), textcoords='data',
             arrowprops=dict(arrowstyle='<->', connectionstyle='arc3', 
                            color='green'))
ax4b.text((dfnew['CritPeriod0'][3]+dfnew['CritPeriod1'][3])/2.4,\
         4.2,r'$\mathrm{\mathbb{P}}_{\rm crit}$',color='green',fontsize=20)
ax4b.annotate('', xy=(dfnew['MainPeriod0'][3], 4), xycoords='data',
             xytext=(Tsim, 4), textcoords='data',
             arrowprops=dict(arrowstyle='<->', connectionstyle='arc3', 
                            color='blue'))
ax4b.text((dfnew['MainPeriod0'][3]+Tsim)/2.1,\
         4.2,r'$\mathrm{\mathbb{P}}_{\rm m}$',color='blue',fontsize=20)
...
plt.savefig('Figure 5A-2.tif', dpi=300,pad_inches=0)
...
ax1b.axvline(dfnew['TreatmentPeriod1'][0],color='k',linestyle='--',linewidth=2)
ax1b.axvline(dfnew['CritPeriod1'][0],color='k',linestyle='--',linewidth=2)
ax1b.annotate('', xy=(0, 1.35), xycoords='data',
             xytext=(dfnew['TreatmentPeriod1'][0], 1.35), textcoords='data',
             arrowprops=dict(arrowstyle='<->', connectionstyle='arc3', 
                            color='red'))
ax1b.text(0,1.4,r'$\mathrm{\mathbb{P}}_{\rm t}$',color='red',fontsize=20)
ax1b.annotate('', xy=(dfnew['CritPeriod0'][0], 1.35), xycoords='data',
             xytext=(dfnew['CritPeriod1'][0], 1.35), textcoords='data',
             arrowprops=dict(arrowstyle='<->', connectionstyle='arc3', 
                            color='green'))
ax1b.text((dfnew['CritPeriod0'][0]+dfnew['CritPeriod1'][0])/2.6,\
         1.4,r'$\mathrm{\mathbb{P}}_{\rm crit}$',color='green',fontsize=20)
ax1b.annotate('', xy=(dfnew['MainPeriod0'][0], 1.35), xycoords='data',
             xytext=(Tsim, 1.35), textcoords='data',
             arrowprops=dict(arrowstyle='<->', connectionstyle='arc3', 
                            color='blue'))
ax1b.text((dfnew['MainPeriod0'][0]+Tsim)/2.1,\
         1.4,r'$\mathrm{\mathbb{P}}_{\rm m}$',color='blue',fontsize=20)
ax1b.yaxis.set_tick_params(labelsize=20)
ax1b.set_xlim([0,Tsim])
ax1b.set_ylim([0,1.6])
...
ax2b.annotate('', xy=(0, 1.35), xycoords='data',
             xytext=(dfnew['TreatmentPeriod0'][1]+1, 1.35), textcoords='data',
             arrowprops=dict(arrowstyle='<->', connectionstyle='arc3', 
                            color='red'))
ax2b.text((dfnew['TreatmentPeriod0'][1]+1)/2.4,\
         1.4,r'$\mathrm{\mathbb{P}}_{\rm t}$',color='red',fontsize=20)
ax2b.annotate('', xy=(dfnew['TreatmentPeriod0'][1]+1, 1.35), xycoords='data',
             xytext=(dfnew['CritPeriod1'][1], 1.35), textcoords='data',
             arrowprops=dict(arrowstyle='<->', connectionstyle='arc3', 
                            color='green'))
ax2b.text((dfnew['TreatmentPeriod0'][1]+1+dfnew['CritPeriod1'][1])/2.1,\
         1.4,r'$\mathrm{\mathbb{P}}_{\rm crit}$',color='green',fontsize=20)
ax2b.annotate('', xy=(dfnew['MainPeriod0'][1], 1.35), xycoords='data',
             xytext=(Tsim, 1.35), textcoords='data',
             arrowprops=dict(arrowstyle='<->', connectionstyle='arc3', 
                            color='blue'))
ax2b.text((dfnew['MainPeriod0'][1]+Tsim)/2.1,\
...
plt.savefig('Figure 5B-1.tif', dpi=300, pad_inches=0)
...
ax3b.axvline(dfnew['TreatmentPeriod1'][2],color='k',linestyle='--',linewidth=2)
ax3b.axvline(dfnew['CritPeriod1'][2],color='k',linestyle='--',linewidth=2)
ax3b.annotate('', xy=(dfnew['TreatmentPeriod0'][2], 1.35), xycoords='data',
             xytext=(dfnew['TreatmentPeriod1'][2], 1.35), textcoords='data',
             arrowprops=dict(arrowstyle='<->', connectionstyle='arc3', 
                            color='red'))
ax3b.text((dfnew['TreatmentPeriod0'][2]+dfnew['TreatmentPeriod1'][2])/2.75,\
         1.4,r'$\mathrm{\mathbb{P}}_{\rm t}$',color='red',fontsize=20)
ax3b.annotate('', xy=(dfnew['CritPeriod0'][2], 1.35), xycoords='data',
             xytext=(dfnew['CritPeriod1'][2], 1.35), textcoords='data',
             arrowprops=dict(arrowstyle='<->', connectionstyle='arc3', 
                            color='green'))
ax3b.text((dfnew['CritPeriod0'][2]+dfnew['CritPeriod1'][2])/2.65,\
         1.4,r'$\mathrm{\mathbb{P}}_{\rm crit}$',color='green',fontsize=20)
ax3b.annotate('', xy=(dfnew['MainPeriod0'][2], 1.35), xycoords='data',
             xytext=(Tsim, 1.35), textcoords='data',
             arrowprops=dict(arrowstyle='<->', connectionstyle='arc3', 
                            color='blue'))
ax3b.text((dfnew['MainPeriod0'][2]+Tsim)/2.1,\
...
ax4b.annotate('', xy=(dfnew['CritPeriod0'][3], 11), xycoords='data',
             xytext=(dfnew['CritPeriod1'][3], 11), textcoords='data',
             arrowprops=dict(arrowstyle='<->', connectionstyle='arc3', 
                            color='green'))
ax4b.text((dfnew['CritPeriod0'][3]+dfnew['CritPeriod1'][3])/2.4,\
         11.4,r'$\mathrm{\mathbb{P}}_{\rm crit}$',color='green',fontsize=20)
ax4b.annotate('', xy=(dfnew['MainPeriod0'][3], 11), xycoords='data',
             xytext=(Tsim, 11), textcoords='data',
             arrowprops=dict(arrowstyle='<->', connectionstyle='arc3', 
                            color='blue'))
ax4b.text((dfnew['MainPeriod0'][3]+Tsim)/2.1,\
         11.4,r'$\mathrm{\mathbb{P}}_{\rm m}$',color='blue',fontsize=20)
ax4b.set_xlim([0,Tsim])
...
axins.plot(time4,uLcontrol4,'-.',color='gray')
axins.fill_between(time4,uLcontrol4,0,\
        where=uLcontrol4>=0,color='mediumseagreen',alpha=0.5,interpolate=True)
axins.yaxis.set_tick_params(labelsize=16)
axins.xaxis.set_tick_params(labelsize=16)
axins.set_ylabel('N2/N1',fontsize=12)
x1, x2, y1, y2 = 19.3, 21.1, 0, 1.7 # specify the limits
axins.set_xlim(x1, x2) # apply the x-limit
...
plt.savefig('Figure 5B-2.tif', dpi=300,pad_inches=0)
