...
inhibitor and IFN-beta control.  It creates a folder "AltdataSummary" 
containing a CSV file summarizing the information obtained from 
PeriodAmtAlternating.py after running the following cases 
...
Figures 10(A), 10(B), 11(A), 11(B), 12(A), 12(B) and 12(C).
...
def read_data(path,filename):
    ...
    df.columns = ['TreatmentPeriod0','TreatmentPeriod1', 'TGFAmountTreatment',\
                  ...
                  'TGFAmountRelapse','IFNAmountRelapse', 'RelapsePeriod',\
                  'frequency','totTGFAmount','totIFNAmount'] 
    os.chdir(workingdir)
...
def read_injection(path,filename):
    ...
    dfinj.columns = ['TGFinjall','TGFinj2all','IFNinjall','IFNinj2all'] 
    os.chdir(workingdir)
...
path = os.getcwd()+'/'+'Altdatafile'

filename = ['Altsummary_[C0,I0]=[3,2].csv',\
            'Altsummary_[C0,I0]=[1,2].csv',\
            'Altsummary_[C0,I0]=[1,0.5].csv',\
            'Altsummary_[C0,I0]=[4,0.3].csv']
...
dfnew.to_csv('Altsummary.csv',index=False)
...
pathprof = os.getcwd()+'/'+'Altdatafile'

fileprof = ['Altdata_[C0,I0]=[3,2].csv',\
            'Altdata_[C0,I0]=[1,2].csv',\
            'Altdata_[C0,I0]=[1,0.5].csv',\
            'Altdata_[C0,I0]=[4,0.3].csv']
...
fileprof = ['Altinjsummary_[C0,I0]=[3,2].csv',\
            'Altinjsummary_[C0,I0]=[1,2].csv',\
            'Altinjsummary_[C0,I0]=[1,0.5].csv',\
            'Altinjsummary_[C0,I0]=[4,0.3].csv']

dfinj1 = read_injection(pathprof,fileprof[0])
TGFinj_t11 = dfinj1['TGFinjall']
TGFinj2_t11 = dfinj1['TGFinj2all']
IFNinj_t11 = dfinj1['IFNinjall']
IFNinj2_t11 = dfinj1['IFNinj2all']

dfinj2 = read_injection(pathprof,fileprof[1])
TGFinj_t12 = dfinj2['TGFinjall']
TGFinj2_t12 = dfinj2['TGFinj2all']
IFNinj_t12 = dfinj2['IFNinjall']
IFNinj2_t12 = dfinj2['IFNinj2all']

dfinj3 = read_injection(pathprof,fileprof[2])
TGFinj_t13 = dfinj3['TGFinjall']
TGFinj2_t13 = dfinj3['TGFinj2all']
IFNinj_t13 = dfinj3['IFNinjall']
IFNinj2_t13 = dfinj3['IFNinj2all']

dfinj4 = read_injection(pathprof,fileprof[3])
TGFinj_t14 = dfinj4['TGFinjall']
TGFinj2_t14 = dfinj4['TGFinj2all']
IFNinj_t14 = dfinj4['IFNinjall']
IFNinj2_t14 = dfinj4['IFNinj2all']
...
ax1.legend(handles=[TGF_patch,IFN_patch],bbox_to_anchor=(0,0.75, 1, .6),\
...
ax1b.annotate('', xy=(0, 3), xycoords='data',
             ...
             arrowprops=dict(arrowstyle='<->', connectionstyle='arc3', 
                            color='red'))
ax1b.text(dfnew['TreatmentPeriod1'][0]/2.3,3.15,r'$\mathrm{\mathbb{P}}_{\rm t}$',color='red',fontsize=20)
...
plt.savefig('Figure 10A-1.tif', dpi=300,pad_inches=0)
...
ax3b.annotate('', xy=(0, 3), xycoords='data',
             ...
             arrowprops=dict(arrowstyle='<->', connectionstyle='arc3', 
                            color='red'))
ax3b.text(dfnew['TreatmentPeriod1'][2]/3.3,3.15,r'$\mathrm{\mathbb{P}}_{\rm t}$',color='red',fontsize=20)
...
plt.savefig('Figure 10A-2.tif', dpi=300, pad_inches=0)
...
plt.savefig('Figure 10B-1.tif', dpi=300,pad_inches=0)
...
ax4.text(-0.8,7.5,r'$Q_4$',fontsize=24, bbox=bbox4)
...
plt.savefig('Figure 10B-2.tif', dpi=300,pad_inches=0)
...
plt.savefig('Figure 11A.tif', dpi=300,pad_inches=0)
...
plt.savefig('Figure 11B.tif', dpi=300,pad_inches=0)
